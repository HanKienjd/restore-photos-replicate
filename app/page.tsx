...
const options = {
  ...
  onValidate: async (file: File): Promise<undefined | string> => {
    ...
    return isSafe ? undefined : 'Detected a NSFW image which is not allowed. If this was a mistake, please contact me at hassan@hey.com';
  },
};
    ...
    <ResizablePanel>
      <AnimatePresence mode="wait">
        <motion.div className="flex justify-between items-center w-full flex-col mt-4">
          ...
          />
          {restoredLoaded && sideBySide && (<CompareSlider
          ...
          {originalPhoto && !restoredImage && (<Image
            ...
            height={475}
          />)}
          {restoredImage && originalPhoto && !sideBySide && (<div className="flex sm:space-x-4 sm:flex-row flex-col">
            <div>
